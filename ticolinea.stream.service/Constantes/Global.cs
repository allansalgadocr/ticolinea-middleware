namespace ticolinea.stream.service.Constantes
{
    ...
    {
#if !DEBUG
        public const string STREAMS_FOLDER = "/home/demo/streams/";
        public const string EPG_FOLDER = "/home/demo/EPG/";
        public const string FFMPEG_PATH_SRT = "ffmpeg";
        public const string FFMPEG_PATH = "ffmpeg";
        public const string FFPROBE_PATH = "ffprobe";
        public const string MARIADB_CONN= "server=127.0.0.1;Port=3306;uid=iptvtl;pwd=Qawsedrf7852!;database=demo_iptv;Allow User Variables=True;SSLMode=None;Pooling=true;Min Pool Size=25;Max Pool Size=350;Connection Lifetime=0;AllowPublicKeyRetrieval=true";
