namespace ticolinea.stream.service.Constantes
{
    public static class Global
    {
        ...
        public const string MARIADB_CONN= "server=127.0.0.1;Port=3306;uid=iptvtl;pwd=Qawsedrf7852!;database=iptv;Allow User Variables=True;SSLMode=None;Pooling=true;Min Pool Size=100;Max Pool Size=800;Connection Lifetime=20;AllowPublicKeyRetrieval=true";
