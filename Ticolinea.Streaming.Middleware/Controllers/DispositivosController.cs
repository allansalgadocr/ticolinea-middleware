...
public class DispositivosController : Controller
{
    [HttpPost("{usuario}/{password}")]
        public async Task<IActionResult> AgregarDispositivo([FromBody] Modelos.Dispositivo dispositivo, string usuario, string password)
        {
            ...
            try
            {
                ...
                if (dispositivoBd != null && dispositivoBd.MacAddress.Equals(dispositivo.MacAddress, StringComparison.InvariantCultureIgnoreCase))
                {
        ...
        [HttpPost("{usuario}/{password}")]
        public async Task<IActionResult> ActualizarDispositivo([FromBody] Modelos.Dispositivo dispositivo, string usuario, string password)
        {
            if (usuario != "fibraencasa" || password != "81Yg0") return Unauthorized();
        ...
        [HttpPost("{usuario}/{password}")]
        public async Task<IActionResult> EliminarDispositivo([FromBody] Modelos.Dispositivo dispositivo, string usuario, string password)
        {
            if (usuario != "fibraencasa" || password != "81Yg0") return Unauthorized();
            ...
            try
            {
                ...
                {
                    baseResponse.success = false;
                    baseResponse.error = "No se puede eliminar un dispositivo activo. Proceda a inactivar el disposito y luego eliminarlo.";
        ...
        [HttpPost("{usuario}/{password}")]
        public async Task<IActionResult> ActivarDispositivo([FromBody] Modelos.Dispositivo dispositivo, string usuario, string password)
        {
            if (usuario != "fibraencasa" || password != "81Yg0") return Unauthorized();
            ...
            try
            {
                ...
                if (dispositivoBd != null && dispositivoBd.Activo != 1)
                {
                    ...
                    await Data.Dispositivos.InsertarHistorialAsync(dispositivo.MacAddress, Data.Dispositivos.Estado.ACTIVO, dispositivo.CreadoPor);
        ...
        [HttpPost("{usuario}/{password}")]
        public async Task<IActionResult> InactivarDispositivo([FromBody] Modelos.Dispositivo dispositivo, string usuario, string password)
        {
            if (usuario != "fibraencasa" || password != "81Yg0") return Unauthorized();
            ...
            try
            {
                ...
                if (dispositivoBd != null && dispositivoBd.Activo!=0)
                {
                    ...
                    await Data.Dispositivos.InsertarHistorialAsync(dispositivo.MacAddress, Data.Dispositivos.Estado.INACTIVO, dispositivo.CreadoPor);
        ...
        public async Task<IActionResult> ObtenerDispositivosActivos(string usuario, string password)
        {
            ...
            {
                //verifica si existe la MacAddress
                var dispositivoBd = await Data.Dispositivos.ObtenerDispositivosPorEstadoAsync(Data.Dispositivos.Estado.ACTIVO);
                baseResponse.success = true;
                baseResponse.data = dispositivoBd;
        ...
        public async Task<IActionResult> ObtenerDispositivosInactivos(string usuario, string password)
        {
            ...
            {
                //verifica si existe la MacAddress
                var dispositivoBd = await Data.Dispositivos.ObtenerDispositivosPorEstadoAsync(Data.Dispositivos.Estado.INACTIVO);
                baseResponse.success = true;
                baseResponse.data = dispositivoBd;
