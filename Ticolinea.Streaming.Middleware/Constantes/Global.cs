namespace ticolinea.stream.service.Constantes
{
    public static class Global
    {
        ...
        public const string MARIADB_CONN = "Server=localhost;User ID=root;Password=Qawsedrf7852!;Database=ticolineaplay;Allow User Variables=True;SSLMode=None;Pooling=true;Min Pool Size=20;Max Pool Size=150;Connection Lifetime=600;Default Command Timeout=30;AllowPublicKeyRetrieval=true";
